-- Adjust yearly standard subscription price to 29.900 TL.
...
begin
  ...
  period_price := case requested_billing_period when 'monthly' then 3000 when 'quarterly' then 8400 else 29900 end;
