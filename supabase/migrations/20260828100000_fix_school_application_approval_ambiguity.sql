-- The OUT parameter named school_id previously conflicted with same-named
-- columns in the approval transaction. Prefer table columns in SQL statements
-- while keeping the public RPC signature unchanged.
