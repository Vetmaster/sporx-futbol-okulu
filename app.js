const APP_VERSION = '2026.08.10.256';
...
async function getPushRegistration() {
  ...
  const registration = await navigator.serviceWorker.register('./service-worker.js?v=2026.08.10.256', { scope: './', updateViaCache: 'none' });
