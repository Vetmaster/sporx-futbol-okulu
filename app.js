const APP_VERSION = '2026.08.02.191';
...
async function getPushRegistration() {
  ...
  const registration = await navigator.serviceWorker.register('./service-worker.js?v=2026.08.02.190', { scope: './', updateViaCache: 'none' });
