const APP_VERSION = '2026.08.10.257';
...
async function getPushRegistration() {
  ...
  const registration = await navigator.serviceWorker.register('./service-worker.js?v=2026.08.10.257', { scope: './', updateViaCache: 'none' });
