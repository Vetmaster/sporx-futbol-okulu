const APP_VERSION = '2026.07.24.97';
...
const MENU_ICONS = {
  ...
  training: '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9"></circle><path d="m12 7 3 2-1 4h-4L9 9l3-2ZM12 7V3M15 9l4-2M14 13l3 4M10 13l-3 4M9 9 5 7"></path></svg>',
